...
export default function GenericPage({ title, subtitle, image }) {
    ...
    return (
        <div className="min-h-screen text-white pt-32 px-6" style={{ backgroundColor: 'var(--bg)' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-32">
                    <div>
                        ...
                        <p className="font-sans text-lg opacity-70 leading-relaxed mb-6">
                            At Golden Waka, we believe that travel is not just about the destination, but the journey itself.
